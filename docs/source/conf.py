...
latex_documents = [
  ('index', 'FabGIS.tex', u'FabGIS Documentation',
   u'Tim Sutton', 'manual'),
]
...
man_pages = [
    ('index', 'fabgis', u'FabGIS Documentation',
     [u'Tim Sutton'], 1)
]
...
texinfo_documents = [
  ('index', 'FabGIS', u'FabGIS Documentation',
   u'Tim Sutton', 'FabGIS', 'One line description of project.',
   'Miscellaneous'),
]
